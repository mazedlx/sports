        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden sm:-my-px sm:ml-6 sm:flex sm:space-x-8">
                    <a
                        href="{{ route('/') }}"
                        class="inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-500 border-b-2 @if(request()->routeIs('/')) border-green-500 text-gray-900 @else border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 @endif"
                    >
                        Home
                    </a>
    ...
    >
        ...
        <div class="pt-4 pb-3 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                <a
                    @click.prevent="$refs.logoutForm.submit()"
                    href="#" class="block px-4 py-2 text-base font-medium text-gray-500 hover:text-gray-800 hover:bg-gray-100"> Sign out </a>
            </div>
        </div>
        @endauth
    </div>
